# Copyright (c) 2026 Intelligent Robotics Lab (URJC)
#
...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('easynav_experiments')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        ...
        default_value=os.path.join(
            bringup_dir, 'config', 'easynav.params.mppi.yaml'),
